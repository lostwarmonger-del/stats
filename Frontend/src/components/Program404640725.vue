      ...
      <main class="p-6">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-white mb-8">
          <div class="flex items-center justify-between">
            <div>
              <h1 class="text-3xl font-bold mb-2">برنامه 404640725</h1>
              <p class="text-blue-100 text-lg">فرم ثبت اطلاعات برنامه 404640725</p>
            </div>
...
import ProgramDataModal from './ProgramDataModal404640725.vue'
...
const saveData = async () => {
  ...
  saving.value = true
  try {
    await axios.post('/programs/404640725', formData.value)
